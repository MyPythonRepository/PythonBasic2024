# Користувач вводить рядок. Ваше завдання - перевірити, чи може цей рядок бути
# ім'ям змінної.
#
# Змінна не може:
# - починатися з цифри
# - містити великі літери,
# - пробіл і знаки пунктуації (взяти можна тут string.punctuation), окрім
...
# підкреслення "_". Список зареєстрованих слів можна взяти із keyword.kwlist.
#
# У результаті перевірки на друк виводиться або True, якщо таке ім'я змінної
# допустимо, або False - якщо ні.
