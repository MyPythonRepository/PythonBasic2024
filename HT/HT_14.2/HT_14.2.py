# У цьому завданні Вам необхідно зробити дві речі
# на підставі попереднього ДЗ.
#
...
# Рознесіть класи, які використовували під час виконання завдання
# про групу студентів за модулями.
# Переконайтеся у працездатності проекту –
# створіть окремо файл main.py, у якому необхідно імпортувати
# потрібні класи та запустити код перевірки.
#
...
#
# Результат оформить у вигляді zip-архіву,
# в якому будуть зібрані всі необхідні модулі.
#
