# Для списку цілих чисел потрібно знайти суму елементів із парними
# індексами [0-й, 2-й, 4-й ітд], потім перемножити
# суму на останній елемент вхідного масиву.
...
if len(list1) == 0:
    ...
    even_index_sum = sum(list1[::2])
    result = even_index_sum * list1[-1]
