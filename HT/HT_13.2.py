...
# При досягненні мінімуму потрібно викинути (raise) виняток ValueError,
# з описом, що досягнутий мінімум
...
#
# Приблизний каркас для класу та варіанти перевірки.
# Вам потрібно дописати необхідне замість pass
